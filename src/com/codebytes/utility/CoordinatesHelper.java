...
public class CoordinatesHelper {
    ...
    public static double calculateDistanceInKilometers(List<Coordinates> coordinatesList) {

        return 0.0;
    }

    public static double calculateDistanceInMiles(List<Coordinates> coordinatesList) {
